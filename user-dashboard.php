            ...
            <div class="col-md-12">
                ...
                <div>
                    ...
                    <div class="card-header">
                        <h4>Device Details
                            <a href="user-device-create.php" class="btn btn-primary float-end">Add Device</a>
                        </h4>
                    </div>
                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $device)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $device['tag']; ?></td>
                                                <td>
                                                    <a href="user-device-view.php?id=<?= $device['id']; ?>" class="btn btn-info btn-sm">View</a>
                                                <!--    <a href="device-edit.php?id=<//?= $device['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                    <form action="code.php" method="POST" class="d-inline">
                                                        <button type="submit" name="delete_student" value="<//?=$device['id'];?>" class="btn btn-danger btn-sm">Delete</button>
                                                    </form>
                                                 -->
                                                </td>
                                            </tr>
